...
class OpenCVCudaBenchmarker(Benchmarker):
    ...
    @classmethod
    def output_image_to_np_array(cls, output_image, benchmark_name: str):
        image = output_image.download()
    ...
    def _rotate_90_deg(image):
        ...
        M = cv2.cuda.getRotationMatrix2D(center, 90, 1.0)
